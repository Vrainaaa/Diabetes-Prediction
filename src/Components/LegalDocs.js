  ...
  return (
    <div className="legal-section-title">
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-title">Diabetes Prediction</p>
        <p className="legal-description">
          At Health Plus, we provide an advanced Diabetes Prediction system that
          uses machine learning models to predict whether an individual is at risk
          of developing diabetes. By analyzing factors such as age, glucose levels,
          blood pressure, BMI, and more, our system offers a reliable prediction
          that can help you take preventive measures early.
        </p>

        <p className="legal-title">After Prediction Service</p>
        <p className="legal-description">
          After receiving a diabetes prediction, our platform offers a variety of
          follow-up services to support you in managing your health. This includes
          personalized recommendations for diet, exercise, and lifestyle changes,
          as well as guidance on monitoring glucose levels. We also provide access
          to professional healthcare advice through online consultations with doctors
          who can suggest treatments, lifestyle adjustments, and medications if
          necessary. It's important to act on the prediction results and take
          appropriate measures to maintain your health.
        </p>
